    ...
    >
      ...
      <div className={`${id === 6 && 'flex justify-center'} h-full`}>
        ...
        <div
          className={cn(
            titleClassName,
            `${id === 1 ? 'min-h-60' : id === 2 ? 'min-h-40' : 'min-h-40'} group-hover/bento:scale-95 transition-all ease-out hover:duration-700 relative md:h-full hover:border-none flex flex-col px-5 p-5 lg:p-10 border-2 border-gray-800`
          )}
        >
          ...
          <div
            className={`${
              id === 1
                ? 'text-3xl lg:text-5xl text-yellow-600'
                : 'text-lg lg:text-3xl'
